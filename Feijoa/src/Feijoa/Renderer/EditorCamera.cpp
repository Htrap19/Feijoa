...
namespace Feijoa
{
	...
	void EditorCamera::OnUpdate(Timestep ts)
	{
		if (Input::IsKeyPressed(Key::LeftAlt))
		{
			...
			if (Input::IsKeyPressed(Key::M)) // Mouse Middle button is not working for some reason
				MousePan(delta);
	...
	void EditorCamera::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(FJ_BIND_EVENT_FN(EditorCamera::OnMouseScroll));
	}

...
namespace Fejioa
{
	...
	struct Renderer2DData
	{
		...
		const unsigned int MaxVertices = MaxQuad * 4;
	...
	void Renderer2D::Init()
	{
		...
		s_Data.QuadVertexBuffer = Fejioa::VertexBuffer::Create(s_Data.MaxVertices * sizeof(QuadVertex));
		s_Data.QuadVertexBuffer->SetLayout({
			{ Fejioa::ShaderDataType::Float3, "a_Position" },
			{ Fejioa::ShaderDataType::Float4, "a_Color" },
			{ Fejioa::ShaderDataType::Float2, "a_TexCoord" },
			{ Fejioa::ShaderDataType::Float, "a_TexIndex" },
			{ Fejioa::ShaderDataType::Float, "a_TilingFactor" }
			});
		...
		Fejioa::Ref<Fejioa::IndexBuffer> squereIB = Fejioa::IndexBuffer::Create(quadIndices, s_Data.MaxIndices);
